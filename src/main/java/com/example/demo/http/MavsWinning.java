...
public class MavsWinning {
    public static void main(String[] args) {
        try {
            ...
            server.createContext("/mavs_win", new GamesHandler());
    ...
    private static String parseJsonResponse(String jsonResponse) throws IOException {
        ...
        for (JsonNode gameNode : gamesNode) {
            ...
            // Prüfen, ob die Mavs das Heimteam oder Gastteam sind und gewonnen haben
            if ((homeTeam.equals("Dallas Mavericks") && homeScore > visitorScore) ||
                    (visitorTeam.equals("Dallas Mavericks") && visitorScore > homeScore)) {
